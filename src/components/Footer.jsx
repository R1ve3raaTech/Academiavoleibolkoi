  ...
  return (
    <footer className="border-t border-zinc-200 px-8 py-8">
      <Reveal as="div" y={16} className="flex flex-wrap justify-between gap-8">
        ...
        <div>
          <h3 className="text-sm font-semibold text-orange-600">Contacto</h3>
          <a
            href={`mailto:${CONTACT.email}`}
            className="mt-2 flex items-center gap-1.5 text-sm text-zinc-600 hover:text-orange-600"
          >
        ...
        <div>
          <h3 className="text-sm font-semibold text-orange-600">Redes</h3>
      ...
      <div className="mt-8 flex flex-wrap items-center justify-between gap-2 border-t border-zinc-100 pt-4 text-xs text-zinc-500">
        <span>
