...
export default function Navbar() {
  ...
  return (
    <header className="fixed inset-x-0 top-0 z-50 bg-orange-50/90 backdrop-blur-sm">
      <div className="flex items-center justify-between gap-4 px-8 py-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            aria-expanded={open}
            className="rounded-md p-2 text-zinc-700 hover:bg-orange-100 md:hidden"
          >
      ...
      <nav
        ...
        className="flex flex-col gap-1 overflow-hidden px-8 pb-4 text-sm font-medium text-zinc-700 md:hidden"
      >
        {links.map(({ to, label }) => (
          <NavLink
            key={to}
