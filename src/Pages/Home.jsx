  ...
  return (
    <div>
      ...
      <Reveal as="section" className="px-8 py-24 text-center md:py-32">
        ...
        <p className="mx-auto mt-6 max-w-4xl text-4xl font-bold leading-[1.1] tracking-tight text-zinc-900 md:text-6xl">
          Pasión por el deporte.
          <br />
          <span className="text-blue-700">Formación para la vida.</span>
        </p>
      </Reveal>
      ...
      <section className="bg-zinc-50 px-8 py-20">
        <Reveal
          as="div"
          y={16}
          className="mx-auto flex max-w-3xl flex-wrap items-center gap-10 rounded-2xl bg-white p-8 shadow-sm"
        >
          <img
            src={logo}
      ...
      >
        <div className="text-left">
          ...
          <p className="mt-4 max-w-md text-4xl font-bold leading-[1.1] tracking-tight text-zinc-900 md:text-5xl">
            Respeto y superación, dentro y fuera de la cancha.
          </p>
          <ul className="mt-8 flex flex-wrap gap-5 text-sm font-medium text-blue-700">
            {values.map((value) => (
